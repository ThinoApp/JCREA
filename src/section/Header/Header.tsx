...
const HeaderDesktop = () => {
  ...
  return (
    <motion.div
      ...
      className="hidden lg:flex items-center justify-around px-2 py-2 my-2 bg-black text-white mx-auto w-[97%] rounded-full z-50 lg:py-0"
    >
...
const HeaderMobile = () => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5, ease: "easeOut" }}
      className="lg:hidden w-[90%] h-16 mx-auto rounded-full mt-5  px-5 flex items-center justify-center  bg-black text-white py-2 z-1000"
    >
      <div
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.ul
            ...
            className="absolute top-0 left-0 border bg-black border-black w-full p-5 pb-10 flex flex-col gap-10 z-50"
          >
            <motion.div
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.1, duration: 0.3 }}
              className="LogoContainer flex items-center gap-4"
            >
