...
const menusFooter = [
  ...
  },
  {
    ...
    links: [
      {
        name: "+261 34 14 350 18",
        href: "#",
      },
      {
        name: "rakotomalalathino@gmail.com",
        href: "#",
      },
      {
        name: "https://thinoapp.github.io/PORTFOLIO",
        href: "#",
      },
    ],
  },
  ...
  return (
    <div className="bg-[#272727] px-4 py-12 flex flex-col gap-8 lg:py-24 lg:px-12 rounded-t-4xl">
      ...
      >
        ...
        <button className="font-lufga-medium flex items-center gap-2 px-4 py-2 bg-[#FD853A] text-2xl rounded-full text-white">
          <span>Hire Me</span>
          <ArrowUpRightIcon />
        </button>
      </motion.div>
      ...
      >
        <div className="flex flex-col items-start gap-4 sm:col-span-2 lg:col-span-1">
          <motion.div
            layout
            className="flex items-center gap-4 lg:w-full lg:justify-start"
          ...
          <p className="font-lufga-regular text-lg text-[#FCFCFD] tracing-[-1.5%] lg:text-base">
        ...
        {menusFooter.map((item) => {
          return (
            <div key={item.title} className="flex flex-col gap-3 sm:pl-5">
              <h3 className="font-lufga-semibold text-[#FD853A] text-2xl">
                {item.title}
              </h3>
              <ul className="flex flex-col gap-2">
                {item.links.map((linkItem) => (
                  <li
                    key={linkItem.name}
                    className="text-white font-lufga-regular text-base"
                  >
                    {linkItem.name}
                  </li>
                ))}
